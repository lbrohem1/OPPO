...
settings = {
    ...
    "likeOn": True,
    "autolike": True,
    "comment": "Autolike by 🎩นัก😁ฆ่า👕บ้าเชล👖",
    "timeline": False,
    "commentOn":True,
    "commentBlack":{},
    "wblack": False,
    ...
    "userMentioned": False,
    "timeRestart": "18000",
    "message1":"🕵 🎩นัก😁ฆ่า👕บ้าเชล👖🕵",
    "message":"🕵 🎩นัก😁ฆ่า👕บ้าเชล👖🕵",
#    "comment":"""🕵 🎩นัก😁ฆ่า👕บ้าเชล👖 🕵""",
    "comment1":"""🕵 🎩นัก😁ฆ่า👕บ้าเชล👖 🕵""",
    "userAgent": [
...
def helptexttospeech():
    helpTextToSpeech =   """╭─「🎩นัก😁ฆ่า👕บ้าเชล👖」─
│•        TextToSpeech
╰───────────
╭───────────
│• 01. af : แอฟริกัน
...
#==============================================================================#
                ...
                if text.lower() == 'help':
                    ...
                    line.sendMentionFooter(to, '「 User Self 」\n', sender, "https://line.me/ti/p/mfMGEflENb", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/mfMGEflENb', 'type': 'mt', 'subText': "🎩นัก😁ฆ่า👕บ้าเชล👖", 'a-installUrl': 'https://line.me/ti/p/mfMGEflENb', 'a-installUrl': 'https://line.me/ti/p/mfMGEflENb', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/mfMGEflENb', 'i-linkUri': 'https://line.me/ti/p/mfMGEflENb', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/mfMGEflENb'}, contentType=19)
                if text.lower() == 'help1':
                    icon = "http://dl.profile.line.naver.jp/"+lineProfile.pictureStatus
                    name = "🎩นัก😁ฆ่า👕บ้าเชล👖"                   
                    link = "https://line.me/ti/p/mfMGEflENb"
...
#==============================================================================#
                   ...
                   # line.sendContact(to, "u6588c368db2307a41862b7385e00f4d8")                        
                    ...
                    line.sendMessage(to,"BY: 🎩นัก😁ฆ่า👕บ้าเชล👖")       
                    ...
                    line.sendContact(to, lineMID)
                    line.sendMentionFooter(to, '「ผู้ควบคุมบอท」\n', sender, "https://line.me/ti/p/FMRCTkb0nl", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/FMRCTkb0nl', 'type': 'mt', 'subText': "🎩นัก😁ฆ่า👕บ้าเชล👖", 'a-installUrl': 'https://line.me/ti/p/FMRCTkb0nl', 'a-installUrl': 'https://line.me/ti/p/FMRCTkb0nl', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/FMRCTkb0nl', 'i-linkUri': 'https://line.me/ti/p/FMRCTkb0nl', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/FMRCTkb0nl'}, contentType=19)
                   ...
                   # line.sendImageWithURL(msg.to, cover)
                    ...
                    line.sendMentionFooter(to, '「 User Self 」\n', sender, "https://line.me/ti/p/~samuri5.", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~samuri5.', 'type': 'mt', 'subText': "🎩นัก😁ฆ่า👕บ้าเชล👖", 'a-installUrl': 'https://line.me/ti/p/~samuri5.', 'a-installUrl': ' https://line.me/ti/p/~samuri5.', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~samuri5.', 'i-linkUri': 'https://line.me/ti/p/~samuri5.', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~samuri5'}, contentType=19)
                    ...
                    line.sendMusic(to, line.getContact(sender).displayName, "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, str(userid), "🎩นัก😁ฆ่า👕บ้าเชล👖", line.getContact(sender).displayName)
