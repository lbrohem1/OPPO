...
settings = {
    ...
    "likeOn": True,
    "autolike": True,
    "comment": "Autolike by ─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─",
    "timeline": False,
    "commentOn":True,
    "commentBlack":{},
    "wblack": False,
    ...
    "userMentioned": False,
    "timeRestart": "18000",
    "message1":"─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─",
    "message":"─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─",
#    "comment":"""─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─""",
    "comment1":"""─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─""",
    "userAgent": [
...
#==============================================================================#
                   ...
                   # line.sendContact(to, "u6588c368db2307a41862b7385e00f4d8")                        
                    ...
                    line.sendMessage(to,"─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─")
                    ...
                    line.sendMessage(to,"BY: ─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─")       
                    ...
                    line.sendMentionFooter(to, '「 User Self 」\n', sender, "https://line.me/ti/p/~samuri5.", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~samuri5.', 'type': 'mt', 'subText': "─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─", 'a-installUrl': 'https://line.me/ti/p/~samuri5.', 'a-installUrl': ' https://line.me/ti/p/~samuri5.', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~samuri5.', 'i-linkUri': 'https://line.me/ti/p/~samuri5.', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~samuri5'}, contentType=19)
                    ...
                    line.sendMusic(to, line.getContact(sender).displayName, "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, str(userid), "─┅❈͜͡✯ นักฆ่า ✯͜͡❈┅─", line.getContact(sender).displayName)
        ...
        if op.type == 26:
            ...
            if settings["Api"] == True:
                if msg.text in ["กำ","กำหำ","กำหอย"]:
                    line.sendText(msg.to,"กำเบาๆนะเค้าเจ็บ😁เดี๋ยว นมแบน😁")
                    line.sendMessage(msg.to, None, contentMetadata={"STKID":"51626498","STKPKGID":"11538","STKVER":"1"}, contentType=7)
            if settings["Api"] == True:
                if msg.text in ["งง","งงง",]:
                    line.sendText(msg.to,"ไม่ต้องงงคับ ผมหล่อแบบนี้มาตั้งแต่แรกเกิดนานแล้ว😂😂")
            ...
            if settings ["Api"] == True:
                if msg.text in ["อยู่ไหม","เช็คบอท","/เทส","ออนใหม"]:
                    line.sendText(msg.to,"─┅❈͜͡✯บอททำงานอยู่ 100%✯͜͡❈┅─")
            if settings ["Api"] == True:
                if msg.text in ["สวัดดี","หวัดดี","ดีจ้า","ดีครับ","ดี","สวัสดีครับ","สวัสดีค่ะ","ดีงับๆ","ดีงับ","หวัดดีงับๆ"]:
                    line.sendText(msg.to,"สวัสดีครับ ผมชื่อ เอม นะครับ ยินดีที่ได้รู้จัก")
            if settings ["Api"] == True:
                if msg.text in ["/ตั้งเวลา",".ตั้งเวลา",".ตั้ง","/ตั้ง","/จับ"]:
                    line.sendText(msg.to,"─┅❈͜͡✯กำลังรีเซ็ทระบบตั้งค่าคนอ่าน✯͜͡❈┅─")
                    line.sendText(msg.to,".จับ")
            if settings ["Api"] == True:
                if msg.text in ["/อ่าน",".คนอ่าน","/คนอ่าน","/ใครอ่าน",".ใครอ่าน"]:
                    line.sendText(msg.to,"─┅❈͜͡✯ตรวจสอบรายชือคนอ่าน✯͜͡❈┅─")
